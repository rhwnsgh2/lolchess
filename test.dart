class PlayerStatus {
  ...
  PlayerStatus.fromJson(Map<String, dynamic> json) {
    ...
    rankHistory = json["rankHistory"] == null
        ? null
        : List<List<int>>.from(json["rankHistory"]);
...
class PlayerInfo {
  ...
  PlayerInfo.fromJson(Map<String, dynamic> json) {
    ...
    region = json["region"];
    localRank =
        json["localRank"] == null ? null : List<int>.from(json["localRank"]);
    globalRank =
        json["globalRank"] == null ? null : List<int>.from(json["globalRank"]);
    hyperrollLeague = json["hyperrollLeague"] == null
        ? null
        : List<String>.from(json["hyperrollLeague"]);
  }
...
class Matches {
  ...
  Matches.fromJson(Map<String, dynamic> json) {
    ...
    rankChange = json["rankChange"] == null
        ? null
        : List<List<String>>.from(json["rankChange"]);
    ratings =
...
class Ratings {
  ...
  Ratings.fromJson(Map<String, dynamic> json) {
    ...
    econ = json["econ"];
    items = json["items"];
    contestedRatio = json["contestedRatio"];
    contestedRatio2 = json["contestedRatio2"];
    ...
    contested2 = json["contested2"] == null
        ? null
        : List<List<String>>.from(json["contested2"]);
  }
